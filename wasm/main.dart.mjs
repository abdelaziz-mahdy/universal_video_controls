...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1613: x0 => x0.exitFullscreen(),
      _1614: x0 => x0.play(),
      _1615: x0 => x0.pause(),
      _1618: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1621: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1623: (x0,x1) => x0.removeAttribute(x1),
      _1624: x0 => x0.load(),
      _1625: (x0,x1) => x0.start(x1),
      _1626: (x0,x1) => x0.end(x1),
      _1627: x0 => globalThis.Wakelock.toggle(x0),
      ...
      _1886: (x0,x1) => x0.appendChild(x1),
      _1887: (x0,x1) => x0.item(x1),
      _1903: (s, m) => {
        try {
      ...
      _2181: (x0,x1) => x0.draggable = x1,
      _2197: x0 => x0.style,
      _2770: x0 => x0.videoWidth,
      _2771: x0 => x0.videoHeight,
      _2775: (x0,x1) => x0.playsInline = x1,
      _2804: x0 => x0.error,
      ...
      _2832: (x0,x1) => x0.autoplay = x1,
      _2834: (x0,x1) => x0.loop = x1,
      _2836: (x0,x1) => x0.controls = x1,
      _2838: (x0,x1) => x0.volume = x1,
      _2840: (x0,x1) => x0.muted = x1,
      _2855: x0 => x0.code,
      _2856: x0 => x0.message,
      _2932: x0 => x0.length,
      _3129: (x0,x1) => x0.accept = x1,
      _3143: x0 => x0.files,
      _3169: (x0,x1) => x0.multiple = x1,
      _3187: (x0,x1) => x0.type = x1,
      _3441: x0 => x0.src,
      _3442: (x0,x1) => x0.src = x1,
      _3444: (x0,x1) => x0.type = x1,
      _3448: (x0,x1) => x0.async = x1,
      _3462: (x0,x1) => x0.charset = x1,
      _3929: () => globalThis.window,
      _6646: x0 => x0.length,
      _6701: x0 => x0.firstChild,
      _6712: () => globalThis.document,
      _6784: x0 => x0.documentElement,
      _6807: x0 => x0.head,
      _7156: (x0,x1) => x0.id = x1,
      _7183: x0 => x0.children,
      _8725: x0 => x0.size,
      _8733: x0 => x0.name,
      _8740: x0 => x0.length,
      _8751: x0 => x0.result,
      _11422: (x0,x1) => x0.border = x1,
      _11700: (x0,x1) => x0.display = x1,
      _11864: (x0,x1) => x0.height = x1,
      _12554: (x0,x1) => x0.width = x1,
      _12931: x0 => x0.name,
      _12932: x0 => x0.message,
